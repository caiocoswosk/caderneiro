...
4. **Se o modelo for diferente do recomendado** (superior ou inferior): sugira troca via `/models` e **pare — aguarde o usuário decidir**: o usuário pode trocar o modelo ou confirmar para prosseguir com o modelo atual.
